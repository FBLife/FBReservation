...
- (void)viewDidLoad
{
    ...
    [rightview addTarget:self action:@selector(PushToPersonalPage:) forControlEvents:UIControlEventTouchUpInside];
    
    UIButton * searchButton = [UIButton buttonWithType:UIButtonTypeCustom];
    [searchButton setImage:[UIImage imageNamed:@"shezhi.png"] forState:UIControlStateNormal];
    ...
    UIButton * tableHeaderView_button2 = [UIButton buttonWithType:UIButtonTypeCustom];
    
    tableHeaderView_button2.frame = CGRectMake(0,0,320,40);
    
    tableHeaderView_button2.backgroundColor = [UIColor grayColor];
    
    [tableHeaderView_button2 setTitle:@"搜索" forState:UIControlStateNormal];
    
    [tableHeaderView_button2 addTarget:self action:@selector(refresh:) forControlEvents:UIControlEventTouchUpInside];
    
    _myTableView.tableHeaderView = tableHeaderView_button2;
    ...
    UIButton * tableHeaderView_button1 = [UIButton buttonWithType:UIButtonTypeCustom];
    
    tableHeaderView_button1.frame = CGRectMake(0,0,320,40);
    
    [tableHeaderView_button1 setTitle:@"搜索" forState:UIControlStateNormal];
    
    tableHeaderView_button1.backgroundColor = [UIColor grayColor];
    
    [tableHeaderView_button1 addTarget:self action:@selector(refresh:) forControlEvents:UIControlEventTouchUpInside];
    
    _myTableView1.tableHeaderView = tableHeaderView_button1;
    ...
    UIButton * tableHeaderView_button3 = [UIButton buttonWithType:UIButtonTypeCustom];
    
    tableHeaderView_button3.frame = CGRectMake(0,0,320,40);
    
    [tableHeaderView_button3 setTitle:@"搜索" forState:UIControlStateNormal];
    
    tableHeaderView_button3.backgroundColor = [UIColor grayColor];
    
    [tableHeaderView_button3 addTarget:self action:@selector(refresh:) forControlEvents:UIControlEventTouchUpInside];
    
    _myTableView2.tableHeaderView = tableHeaderView_button3;
    ...
    if (!xiala_tab)
    {
        xiala_tab=[[UITableView alloc]initWithFrame:CGRectMake(0,MY_MACRO_NAME?108:88,320,iPhone5?(568-19-44-36):(480-44-36)) style:UITableViewStylePlain];
...
-(void)PushToPersonalPage:(UIButton *)sender
{
    PersonalmoreViewController * personal = [[PersonalmoreViewController alloc] init];
...
- (void)scrollViewDidEndDragging:(UIScrollView *)scrollView willDecelerate:(BOOL)decelerate
{
    ...
    {
        if (_myTableView1.contentOffset.y > 0 && _myTableView1.contentOffset.y < 20) {
            [UIView animateWithDuration:0.2 animations:^{
                _myTableView1.contentOffset = CGPointMake(0,0);
            }];
        }else if (_myTableView1.contentOffset.y > 20 && _myTableView1.contentOffset.y < 40)
        {
            [UIView animateWithDuration:0.2 animations:^{
                _myTableView1.contentOffset = CGPointMake(0,40);
            }];
        }
    }
    ...
    {
        if (_myTableView.contentOffset.y > 0 && _myTableView.contentOffset.y < 20) {
            [UIView animateWithDuration:0.2 animations:^{
                _myTableView.contentOffset = CGPointMake(0,0);
            }];
        }else if (_myTableView.contentOffset.y > 20 && _myTableView.contentOffset.y < 40)
        {
            [UIView animateWithDuration:0.2 animations:^{
                _myTableView.contentOffset = CGPointMake(0,40);
            }];
        }
    }
    
    
    if (scrollView == _myTableView2)
    {
        if (_myTableView2.contentOffset.y > 0 && _myTableView2.contentOffset.y < 20) {
            [UIView animateWithDuration:0.2 animations:^{
                _myTableView2.contentOffset = CGPointMake(0,0);
            }];
        }else if (_myTableView2.contentOffset.y > 20 && _myTableView2.contentOffset.y < 40)
        {
            [UIView animateWithDuration:0.2 animations:^{
                _myTableView2.contentOffset = CGPointMake(0,40);
            }];
        }
    }
