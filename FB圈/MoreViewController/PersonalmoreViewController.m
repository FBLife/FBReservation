...
- (void)viewDidLoad
{
    ...
    //
    if (MY_MACRO_NAME) {
        _myTableView = [[UITableView alloc] initWithFrame:CGRectMake(0,IOS_VERSION>=7.0?0:0,320,iPhone5?(568-64):(480-64)) style:UITableViewStylePlain];
    }else{
...
//        }
        ...
        follow_label.textAlignment=NSTextAlignmentCenter;
